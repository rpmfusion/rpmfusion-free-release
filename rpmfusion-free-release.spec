...
# Links for the keys
ln -s $(basename %{SOURCE28}) %{buildroot}%{_sysconfdir}/pki/rpm-gpg/RPM-GPG-KEY-rpmfusion-%{repo}-fedora-latest
ln -s $(basename %{SOURCE29}) %{buildroot}%{_sysconfdir}/pki/rpm-gpg/RPM-GPG-KEY-rpmfusion-%{repo}-fedora-rawhide
...
%changelog
* Mon Mar 19 2018 Xavier Bachelot <xavier@bachelot.org> - 27-2
- Create sub-package for tainted repo.

* Mon Nov 13 2017 Nicolas Chauvet <kwizart@gmail.com> - 27-1
- Update to f27 Final
