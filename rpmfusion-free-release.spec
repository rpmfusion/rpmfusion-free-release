...
# Links for the keys
ln -s $(basename %{SOURCE32}) %{buildroot}%{_sysconfdir}/pki/rpm-gpg/RPM-GPG-KEY-rpmfusion-%{repo}-fedora-latest
...
%changelog
* Thu Apr 23 2020 Leigh Scott <leigh123linux@gmail.com> - 32-1
- Release for f32

* Mon Feb 17 2020 Leigh Scott <leigh123linux@gmail.com> - 32-0.3
